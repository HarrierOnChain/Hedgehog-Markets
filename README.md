...
[![CI](https://github.com/HarrierOnChain/Hedgehog-Markets/actions/workflows/ci.yml/badge.svg)](https://github.com/HarrierOnChain/Hedgehog-Markets/actions/workflows/ci.yml)

> Automated **Hedgehog Markets trading bot** — Solana / social. Part of the [Prediction Market Toolkits](https://github.com/HarrierOnChain/Prediction-Markets-Trading-Bot-Toolkits) suite: one execution core, one risk layer, every venue.

**Hedgehog Markets** is **live in production today.**

---

## Strategies on Hedgehog Markets

These bots run on Hedgehog Markets through a single venue adapter on the shared engine — same risk controls, same TUI, full dry-run support.
...
```bash
git clone https://github.com/HarrierOnChain/Hedgehog-Markets.git
cd Hedgehog-Markets
...
This repo is the **Hedgehog Markets** entry point. The execution core, risk layer, and all 20+ venue adapters live in the main toolkit:
...
[Polymarket](https://github.com/HarrierOnChain/Polymarket) · [Crypto.com Predictions](https://github.com/HarrierOnChain/Crypto.com-Predictions) · [Kalshi](https://github.com/HarrierOnChain/Kalshi) · [Manifold Markets](https://github.com/HarrierOnChain/Manifold-Markets)
...
> Trading prediction markets involves real financial risk. This software is provided as-is, without warranty. It is not financial advice. Always test with `enable_trading: false` before deploying real capital. Ensure compliance with Hedgehog Markets's terms of service and your local regulations.

---

<div align="center">

**Hedgehog Markets trading bot · built on the [Prediction Market Toolkits](https://github.com/HarrierOnChain/Prediction-Markets-Trading-Bot-Toolkits) engine**
